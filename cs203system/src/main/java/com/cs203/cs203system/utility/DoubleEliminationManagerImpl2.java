...
//
//@Service
//public class DoubleEliminationManagerImpl2 implements DoubleEliminationManager2 {
//
//    private static final Logger logger = LoggerFactory.getLogger(DoubleEliminationManagerImpl2.class);
//
//    @Autowired
...
//        List<List<Player>> upper_lower_players = splitMatch(players); //First element is always upper players, second element is always lower players
//        List<Player> upperBracketPlayers = upper_lower_players.get(0);
//        List<Player> lowerBracketPlayers = upper_lower_players.get(1);
//
//        List<Match> upperBracketMatch = createBracketMatches(tournament, upperBracketPlayers, round);
//        List<Match> lowerBracketMatch = createBracketMatches(tournament, lowerBracketPlayers, round);
//
//        if (upperBracketPlayers.size() == 1 && lowerBracketPlayers.size() == 2) {
//            playMatches(lowerBracketMatch);
//        }
//        playMatches(upperBracketMatch);
